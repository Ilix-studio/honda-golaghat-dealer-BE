...
// Main Schema
const valueAddedServiceSchema = new mongoose_1.Schema({
    serviceName: {
        type: String,
...
const ValueAddedServiceModel = mongoose_1.default.model("ValueAddedService", valueAddedServiceSchema);
exports.default = ValueAddedServiceModel;
